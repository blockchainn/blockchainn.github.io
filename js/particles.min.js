    ...
    a && Object.deepExtend(i, a), i.tmp.obj = {
        ...
        if (i.interactivity.events.onhover.enable && isInArray("repulse", i.interactivity.events.onhover.mode) && "mousemove" == i.interactivity.status) {
            var a = e.x - i.interactivity.mouse.pos_x,
                ...
                s = a / n,
                r = t / n,
                c = clamp(1 / (l = i.interactivity.modes.repulse.distance) * (-1 * Math.pow(n / l, 2) + 1) * l * 100, 0, 50),
                o = {
                    x: e.x + s * c,
                    y: e.y + r * c
                };
            ...
            if (i.tmp.repulse_finish || (i.tmp.repulse_count++, i.tmp.repulse_count == i.particles.array.length && (i.tmp.repulse_finish = !0)), i.tmp.repulse_clicking) {
                var l = Math.pow(i.interactivity.modes.repulse.distance / 6, 3),
                    ...
                    m = -l / d * 1;
                d <= l && function () {
                    var a = Math.atan2(p, v);
                    if (e.vx = m * Math.cos(a), e.vy = m * Math.sin(a), "bounce" == i.particles.move.out_mode) {
                        var t = e.x + e.vx,
                            n = e.y + e.vy;
                        t + e.radius > i.canvas.w ? e.vx = -e.vx : t - e.radius < 0 && (e.vx = -e.vx), n + e.radius > i.canvas.h ? e.vy = -e.vy : n - e.radius < 0 && (e.vy = -e.vy)
                    }
                }()
